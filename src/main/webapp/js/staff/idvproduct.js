                ...
                if (body[i].status == "0"){
                  ...
                  let text = `
                    <tr class="idv">
                        ...
                        <td>${idvStatus}</td>
                        <td>${gymName}</td>
                        <td><button type="button" class="btn btn-primary xxx" data-toggle="modal" data-target="#exampleModalCenter" name="edits" id="idv${body[i].idvId}" value="${body[i].idvId}">編輯</button></td>
                    </tr>`;
