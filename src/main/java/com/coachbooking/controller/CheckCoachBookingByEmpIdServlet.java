...
@WebServlet("/coachBooking/CheckCoachBookingByEmpIdServlet")
public class CheckCoachBookingByEmpIdServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Step.2 執行SVC
        List<CoachBooking> coachBookingResult = _coachBookingService.checkBookingCoachByEmpId(coachBooking);
