$(function () {
    ...
    $(document).ready(function () {
        ...
        function loadTeamClassList() {
            $.ajax({
                url: "/simplefitness-servlet/courseList/getAllCourse",
                type: "GET",
                dataType: "json",
                success: function (data) {
                    var optionStr = "";
        ...
        function getCourseList() {
            $.ajax({
                url: "/simplefitness-servlet/courseBooking/SearchCourseServlet",
                type: "POST",
                data: JSON.stringify({
        ...
        function checkBooking(item) {
            $.ajax({
                url: "/simplefitness-servlet/courseBooking/BookCourseServlet",
                type: "POST",
                data: JSON.stringify({
