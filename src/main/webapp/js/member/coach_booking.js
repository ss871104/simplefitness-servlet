$(function () {
    ...
    $(document).ready(function () {
        ...
        function loadCoachList() {
            $.ajax({
                url: "http://localhost:8080/simplefitness-servlet/coachBooking/SearchCoachByJobServlet",
                type: "POST",
                dataType: "json",
                success: function (data) {
                    var optionStr = "";
        ...
        function getCoachClassList() {
            $.ajax({
                url: "http://localhost:8080/simplefitness-servlet/coachBooking/SearchCoachServlet",
                type: "POST",
                data: JSON.stringify({
