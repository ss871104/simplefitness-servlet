...
@WebServlet("/coachBooking/CancelCoachClassFromCoachServlet")
public class CancelCoachClassFromCoachServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (coachBookingResult) {
			_coachBookingService.sendCancelMailToMember(coachBooking.getMemId());
