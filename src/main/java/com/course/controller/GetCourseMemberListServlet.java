...
@WebServlet("/course/GetCourseMemberList")
public class GetCourseMemberListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Course> courseResult = _courseService.selectBookedMemberByCourseId(course);
